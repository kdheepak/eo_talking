...
from constants import START_TIME,END_TIME,TIMESTEP,MARKET_SOLVE_TIME,HOME_UPDATE_FREQ,MARKET_SOLVE_FREQ,DEC_TOLERANCE,fedinitstring
import numpy as np


class House(HelicsAgent):
    def __init__(self,house_id, node_id, fed_name, message_interval=TIMESTEP,fedinitstring=fedinitstring ):
        self.id = house_id
