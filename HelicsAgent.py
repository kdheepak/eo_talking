...
class HelicsAgent:
    ...
    def create_federate(self, fedinitstring, message_interval, type="value"):
        ...
        status = h.helicsFederateInfoSetTimeProperty(
            fedinfo, h.helics_property_time_delta, message_interval
        )
    ...
    def publish(self, name, value):
        ...
        print(
            "{} Sent value = {} at time {} from subscription {}".format(
                self.fed_name, value, self.current_time, name
            )
        )
    ...
    def fetch_subscription(self, name):
        ...
        print(
            "{} Received value = {} at time {} from subscription {}".format(
                self.fed_name, value, self.current_time, name
            )
        )
        try:
